...
export default ({
  ...
  // fonts
  util.OpenSans = { fontFamily: `'Open Sans', sans-serif` }
  util.AvenirHeavy = { fontFamily: `'AvenirLTStd-Heavy', sans-serif` }
  util.AvenirHeavyOblique = { fontFamily: `'AvenirLT-HeavyOblique', sans-serif` }
  util.AvenirOblique = { fontFamily: `'AvenirLTStd-Oblique', sans-serif` }
  util.AvenirRoman = { fontFamily: `'AvenirLTStd-Roman', sans-serif` }
  util.AvenirMedium = { fontFamily: `'AvenirLTStd-Medium', sans-serif` }
  util.AvenirLight = { fontFamily: `'AvenirLTStd-Light', sans-serif` }
  util.AvenirLightOblique = { fontFamily: `'AvenirLTStd-LightOblique', sans-serif` }
